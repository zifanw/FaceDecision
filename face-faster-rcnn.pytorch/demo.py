...
def parse_args():
    ...
    parser.add_argument('--image_dir', dest='image_dir',
                        help='directory to load images for demo', default="data/WIDER2015/WIDER_val/images",
                        nargs=argparse.REMAINDER)
    parser.add_argument('--out_dir', dest='out_dir',
                        help='directory to save bboxes for demo',
                        default="/home/hale/src/faster-rcnn.pytorch/data/WIDER2015/eval_tools/pred",
                        nargs=argparse.REMAINDER)
...
if __name__ == '__main__':
    ...
    imglist = sorted(glob(os.path.join(args.image_dir, '*/*.jpg')))
    ...
    for i in range(num_images):
        ...
        for j in xrange(1, len(pascal_classes)):
            ...
            if inds.numel() > 0:
                ...
                cls_dets = torch.cat((cls_boxes, cls_scores.view([-1, 1])), 1)
            ...
            export_bboxes(im_file, cls_dets, bboxes_path)
